...
app.createModal = function(modal) {
  ...
  modal.on('close', function(action, cancel) {
    var model = this.model
    if (action == "primary") {
      console.log("validate" + document.getElementById('selectCollectionArtist').value);
      model.push('_page.collection.artists', document.getElementById('selectCollectionArtist').value);
      model.push('_page.artistCollection', document.getElementById('selectCollectionArtist').value)
      console.log(model.get('_page.collection.artists'));
      console.log("currentId="+model.get('_page.collection.id'));
      model.set('collection.'+model.get('_page.collection.id'), model.get("_page.collection"));
    } else {
